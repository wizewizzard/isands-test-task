...
public class PurchaseTypePersistenceImpl
	 ...
	 */
	@Override
	public List<PurchaseType> findByGroupIdName(long groupId, String name) {
	 ...
	 */
	@Override
	public List<PurchaseType> findByGroupIdName(
	...
	public List<PurchaseType> findByGroupIdName(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (PurchaseType purchaseType : list) {
					if ((groupId != purchaseType.getGroupId()) ||
						!name.equals(purchaseType.getName())) {
	 ...
	 */
	@Override
	public PurchaseType findByGroupIdName_First(
			long groupId, String name,
			OrderByComparator<PurchaseType> orderByComparator)
		throws NoSuchPurchaseTypeException {

		PurchaseType purchaseType = fetchByGroupIdName_First(
	 ...
	 */
	@Override
	public PurchaseType fetchByGroupIdName_First(
		long groupId, String name,
		OrderByComparator<PurchaseType> orderByComparator) {

		List<PurchaseType> list = findByGroupIdName(
	 ...
	 */
	@Override
	public PurchaseType findByGroupIdName_Last(
			long groupId, String name,
			OrderByComparator<PurchaseType> orderByComparator)
		throws NoSuchPurchaseTypeException {

		PurchaseType purchaseType = fetchByGroupIdName_Last(
			groupId, name, orderByComparator);
	 ...
	 */
	@Override
	public PurchaseType fetchByGroupIdName_Last(
		long groupId, String name,
		OrderByComparator<PurchaseType> orderByComparator) {
	 ...
	 */
	@Override
	public PurchaseType[] findByGroupIdName_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIdName_PrevAndNext(
				session, purchaseType, groupId, name, orderByComparator, true);

			array[1] = purchaseType;

			array[2] = getByGroupIdName_PrevAndNext(
				session, purchaseType, groupId, name, orderByComparator, false);
	...
	protected PurchaseType getByGroupIdName_PrevAndNext(
		Session session, PurchaseType purchaseType, long groupId, String name,
		OrderByComparator<PurchaseType> orderByComparator, boolean previous) {
