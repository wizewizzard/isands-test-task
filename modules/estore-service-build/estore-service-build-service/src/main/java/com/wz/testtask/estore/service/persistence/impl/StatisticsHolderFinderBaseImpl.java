 ...
 * @generated
 */
public abstract class StatisticsHolderFinderBaseImpl
	extends BasePersistenceImpl<StatisticsHolder> {

	public StatisticsHolderFinderBaseImpl() {
		setModelClass(StatisticsHolder.class);
	}
