...
public class DeviceTypePersistenceImpl
	 ...
	 */
	@Override
	public List<DeviceType> findByGroupIdName(long groupId, String name) {
	 ...
	 */
	@Override
	public List<DeviceType> findByGroupIdName(
	...
	public List<DeviceType> findByGroupIdName(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DeviceType deviceType : list) {
					if ((groupId != deviceType.getGroupId()) ||
						!name.equals(deviceType.getName())) {
	...
	public DeviceType findByGroupIdName_First(
		...
		DeviceType deviceType = fetchByGroupIdName_First(
	...
	public DeviceType fetchByGroupIdName_First(
		...
		List<DeviceType> list = findByGroupIdName(
	...
	public DeviceType findByGroupIdName_Last(
		...
		DeviceType deviceType = fetchByGroupIdName_Last(
			groupId, name, orderByComparator);
	...
	public DeviceType[] findByGroupIdName_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIdName_PrevAndNext(
				session, deviceType, groupId, name, orderByComparator, true);

			array[1] = deviceType;

			array[2] = getByGroupIdName_PrevAndNext(
				session, deviceType, groupId, name, orderByComparator, false);
	...
	protected DeviceType getByGroupIdName_PrevAndNext(
		Session session, DeviceType deviceType, long groupId, String name,
		OrderByComparator<DeviceType> orderByComparator, boolean previous) {
