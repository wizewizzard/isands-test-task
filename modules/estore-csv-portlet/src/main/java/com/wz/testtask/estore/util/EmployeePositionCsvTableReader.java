...
public class EmployeePositionCsvTableReader implements CsvTableReader {
    ...
    public boolean isSuitable(String fileName) {
        return fileName.toLowerCase().equals("ESTORE_EmployeePosition.csv".toLowerCase());
    }
    ...
    public void readCsvFile(ServiceContext serviceContext, BufferedReader reader) throws IOException, DataFormatException {
        ...
        while ((line = reader.readLine()) != null) {
            try {
                ...
                EmployeePositionLocalServiceUtil.addEmployeePosition(name, serviceContext);
