...
public class DeviceTypeCsvTableReader implements CsvTableReader{
    ...
    public boolean isSuitable(String fileName) {
        return fileName.toLowerCase().equals("ESTORE_DeviceType.csv".toLowerCase());
    }
    ...
    public void readCsvFile(ServiceContext serviceContext, BufferedReader reader) throws IOException, DataFormatException {
        ...
        while ((line = reader.readLine()) != null) {
            try {
                ...
                DeviceTypeLocalServiceUtil.addDeviceType(name, serviceContext);
